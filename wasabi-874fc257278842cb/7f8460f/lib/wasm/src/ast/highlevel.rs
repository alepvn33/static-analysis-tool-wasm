...
impl NumericOp {
    pub fn to_type(self) -> FunctionType {
        ...
        match self {
            ...
            I32Extend8S => FunctionType::new(&[I32], &[I32]),
            I32Extend16S => FunctionType::new(&[I32], &[I32]),
            I64Extend8S => FunctionType::new(&[I64], &[I64]),
            I64Extend16S => FunctionType::new(&[I64], &[I64]),
            I64Extend32S => FunctionType::new(&[I64], &[I64]),
...
impl Instr {
    ...
    pub fn to_type(&self) -> Option<FunctionType> {
        ...
        match *self {
            ...
            MemoryCopy(_) => Some(FunctionType::new(&[I32, I32, I32], &[I32])),
    ...
    pub fn to_name(&self) -> &'static str {
        ...
        match *self {
            ...
            Numeric(I32Extend8S) => "i32.extend8_s",
            Numeric(I32Extend16S) => "i32.extend16_s",
            Numeric(I64Extend8S) => "i64.extend8_s",
            Numeric(I64Extend16S) => "i64.extend16_s",
            Numeric(I64Extend32S) => "i64.extend32_s",
        }
    }
}
